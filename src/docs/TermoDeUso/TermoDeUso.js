...
const TermoDeUso = () => {
    ...
    return (
        ...
        6.1. Infringência de Direitos. Alegações de infringência de direito autoral de qualquer conteúdo disponível no Churrapp devem ser encaminhadas por meio do e-mail<Text style={{ color: 'maroon' }}> contato.churrapp@gmail.com</Text>.
</Text>
                        <Text style={{ textAlign: 'justify' }}>
        ...
        9.4. Dúvidas. Caso você tenha alguma dúvida, comentário ou sugestão, por favor entre em contato conosco por meio do e-mail <Text style={{ color: 'maroon' }}>contato.churrapp@gmail.com</Text>.
</Text>
                    </ScrollView>
                </View>
                // </View>
